...
//
//    public InventoryContainer(IInventory iinventory, IBothE ibothe, EntityPlayer entityplayer)
//    {
//        this.entityplayer = entityplayer;
//        this.ibothe = ibothe;
//        this.ibothe.doContainer();
...
//    {
//        return new InventoryContainer(entityplayer.inventory, ServerE.S_MAP.get(entityplayer.getEntityData().getUniqueId("Nali_small")), entityplayer);
//    }
//
////    @Override
