...
//            c.i.getBD()
            ...
            c.x = ByteReader.getFloat(clientmessage.data, 1 + 16 + 4);
            c.y = ByteReader.getFloat(clientmessage.data, 1 + 16 + 4 + 4);
            c.z = ByteReader.getFloat(clientmessage.data, 1 + 16 + 4 + 4 + 4);
            ...
            c.hp = ByteReader.getInt(clientmessage.data, 1 + 16 + 4 + 4 + 4 + 4 + string.getBytes().length/* + frame*/ + 1);
//            PageArmy.BYTE |= 2;
            PageArmy.BYTE |= 1;
        }
    }
