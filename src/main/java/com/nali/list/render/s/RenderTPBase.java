...
public class RenderTPBase<BD extends IBothDaSn, RC extends IClientDaS> extends SmallRenderS<BD, RC>
{
    ...
    public static void setTextureMap()
    {
        ...
        TEXTURE_MAP.put(G_LIST.get(ICLIENTDAS.StartPart()).element_array_buffer, com.nali.render.RenderHelper.getTextureBuffer(new ResourceLocation("textures/blocks/obsidian.png")));
        TEXTURE_MAP.put(G_LIST.get(ICLIENTDAS.StartPart() + 1).element_array_buffer, diamond_block);
        TEXTURE_MAP.put(G_LIST.get(ICLIENTDAS.StartPart() + 2).element_array_buffer, diamond_block);
    }
