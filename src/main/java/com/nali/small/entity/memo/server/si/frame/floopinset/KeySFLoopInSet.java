...
{
	public KeySFLoopInSet(S s, byte key_data_index)
	{
...
//
//		if (key_short_array[key_short_index] >= fix_key_short_array[fix_key_index0 + 1] && key_short_array[key_short_index] < fix_key_short_array[fix_key_index1 + 1])
//		{
