...
public class FrameSleShootAttackPlus<SD extends ISoundDaLe, BD extends IBothDaNe & IBothDaSn, E extends EntityLe, I extends IMixLe<SD, BD, E>, S extends ServerSle<SD, BD, E, I, A>, A extends MixAIE<SD, BD, E, I, S>> extends FrameSleShoot<SD, BD, E, I, S, A>
{
    public byte
//    start_attack,
    attack;
...
//        start_id = 13;
        ...
        if (this.s.frame_int_array[frame] == frame_2d_int_array[attack][1] - 1)
        {
//            start_id = 2;
//            id = 10;
            this.s.frame_int_array[frame] = frame_2d_int_array[2][0];
