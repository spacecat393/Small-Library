...
public class KeySleFLoopOffSetAttackEndWalkRSe
<
...
> extends KeySleFLoopOffSetAttackEndWalk<BD, E, I, S, MS>
{
	public SIEPlayWithRSe<S2, BD2, E2, I2, A2, BD, E, I, S, MS> sieplaywithrse;

	public KeySleFLoopOffSetAttackEndWalkRSe(S s, byte key_data_index)
	{
