...
public class FrameETLoopInSet<SD extends ISoundN, BD extends IBothDaE, E extends Entity, I extends IMixE<SD, BD, E>, S extends ServerE<SD, BD, E, I, A>, A extends MixAIE<SD, BD, E, I, S>> extends FrameE<SD, BD, E, I, S, A>
{
    public byte index1;

    public FrameETLoopInSet(S s, byte frame, byte index, byte index1)
    {
        super(s, frame, index);
        this.index1 = index1;
    }
