...
{
    public static List<Class> TILES_CLASS_LIST = Reflect.getClasses("com.nali.list.tiles");
    static
    {
...
//    @SideOnly(Side.CLIENT)
    ...
    {
        List<Class> tilerender_class_list = Reflect.getClasses("com.nali.list.tilerender");
