...
{
    public String b0 = I18n.translateToLocal("gui.info." + Reference.MOD_ID + ".ba0");
    public String b1 = I18n.translateToLocal("gui.info." + Reference.MOD_ID + ".ba1");
    ...
    public AttackGUIFeatures(MixGui mixgui)
    {
        ...
        this.string_array = new String[]
        {
            ...
            this.b0 + " : " + I18n.translateToLocal("gui.info." + Reference.MOD_ID + ".ba00"),
            this.b1 + " : " + I18n.translateToLocal("gui.info." + Reference.MOD_ID + ".ba10")
        };
        this.createColor();
    }
