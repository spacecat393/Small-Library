...
{
    public String b0 = I18n.translateToLocal("info." + Small.ID + ".bc0");
    public String b1 = I18n.translateToLocal("info." + Small.ID + ".bc1");
    ...
    public WalkToGUIFeatures(MixGui mixgui)
    {
        ...
        this.string_array = new String[]
        {
            ...
            this.b0 + " : " + I18n.translateToLocal("info." + Small.ID + ".bc2"),
            this.b1 + " : " + I18n.translateToLocal("info." + Small.ID + ".bc3")
        };
        this.createColor();
    }
