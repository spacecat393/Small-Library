...
public class PageAttribute extends PageSelect
{
	...
	public void init()
	{
		...
		if (BYTE_ARRAY != null)
		{
			...
			this.boxtextall_array[index++] = new BoxTextAll("ATTRIBUTE".toCharArray());
	...
	public void enter()
	{
		...
		if (boxtextall_array_length == 6)
		{
			...
			{
				case 2:
					byte_array[2] = SDaAttribute.I_MORE;
					break;
				case 3:
					byte_array[2] = SDaAttribute.I_LESS;
					break;
				case 4:
					byte_array[2] = SDaAttribute.I_FETCH;
					break;
				case 5:
					this.back();
					return;
...
//				this.set(new PageAttributeE(), new KeyEdit());
		...
		byte_array[3] = PAGE;
		ByteWriter.set(byte_array, PageEntityMe.ID, 4);
