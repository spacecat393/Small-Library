...
public class ArrowEntitiesRender extends LayerRender
{
    ...
    public ArrowEntitiesRender(SkinningEntities skinningentities)
    {
    ...
    public void layer(SkinningEntitiesRender skinningentitiesrender, float partialTicks)
    {
        ...
        if (i > 0)
        {
            ...
            for (int j = 0; j < i; ++j)
            {
                ...
                skinningentitiesrender.doModel(this.skinningentities, int_array[0], int_array[1], () ->
                {
