...
//            String name = clasz.getSimpleName().toLowerCase();
                ...
                EntityRegistry.registerModEntity(new ResourceLocation(string_array[1], name), clasz, name, index++, Small.I, 64, 1, true, (int)clasz.getField("eggPrimary").get(null), (int)clasz.getField("eggSecondary").get(null));
