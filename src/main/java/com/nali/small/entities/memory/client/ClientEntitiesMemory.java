...
public abstract class ClientEntitiesMemory extends BothEntitiesMemory
{
//    @SideOnly(Side.CLIENT)
...
//    @SideOnly(Side.CLIENT)
    ...
    public MixBoxEntitiesMemory mixboxentitiesmemory;
    ...
    public ClientEntitiesMemory(SkinningEntities skinningentities, BothData bothdata, WorkBytes workbytes)
    {
        ...
        this.objectrender = this.createObjectRender();
        ...
        this.mixboxentitiesmemory = new MixBoxEntitiesMemory(skinningentities);
    }
