...
{
    public String b0 = I18n.translateToLocal("info." + Small.ID + ".bd0");
    public String b1 = I18n.translateToLocal("info." + Small.ID + ".bd1");
    ...
    public LookToGUIFeatures(MixGui mixgui)
    {
        ...
        this.string_array = new String[]
        {
            ...
            this.b0 + " : " + I18n.translateToLocal("info." + Small.ID + ".bd2"),
            this.b1 + " : " + I18n.translateToLocal("info." + Small.ID + ".bd3")
        };
        this.createColor();
    }
