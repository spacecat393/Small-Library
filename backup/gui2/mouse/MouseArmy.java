...
import com.nali.small.gui.page.PageTextSearch;
...
public class MouseArmy extends Mouse
{
	...
	public void run()
	{
		...
		{
			KeyMenu.STATE |= 4;
			PageTextSearch.STATE_BYTE_ARRAY[PageArmy.TEXT_INDEX] |= 1;
		}
		else if ((STATE & 1) == 1)
		{
			KeyMenu.STATE &= 255-4;
			PageTextSearch.STATE_BYTE_ARRAY[PageArmy.TEXT_INDEX] &= 255-1;
		}
