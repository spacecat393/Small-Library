...
import com.nali.list.entity.si.AILeUseTo;
...
import com.nali.small.gui.features.messages.works.UseToGUIFeatures;
...
//        {
        ...
        {
//            g.sendPacketUUIDInt(cliententitiesmemory.workbytes.USE_TO());
            g.sendPacketUUIDInt(AILeUseTo.ID);
        }

        if (!(GUIFEATURESLOADER instanceof UseToGUIFeatures))
        {
            GUIFEATURESLOADER = new UseToGUIFeatures(g);
        }
        g.state |= 2;
//        }
    }
