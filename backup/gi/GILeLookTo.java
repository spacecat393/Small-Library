...
import com.nali.list.entity.ai.AILeLookTo;
...
import com.nali.small.gui.features.messages.works.LookToGUIFeatures;
...
//        {
        ...
        {
//            g.sendPacketUUIDInt(cliententitiesmemory.workbytes.LOOK_TO());
            g.sendPacketUUIDInt(AILeLookTo.ID);
        }

        if (!(GUIFEATURESLOADER instanceof LookToGUIFeatures))
        {
            GUIFEATURESLOADER = new LookToGUIFeatures(g);
        }
        g.state |= 2;
//        }
    }
