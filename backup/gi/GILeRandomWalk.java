...
import com.nali.small.gui.features.messages.works.RandomWalkGUIFeatures;
...
//            {
        ...
        {
//            g.sendPacketUUIDInt(cliententitiesmemory.workbytes.RANDOM_WALK());
            g.sendPacketUUIDInt(AILeRandomWalk.ID);
        }

        if (!(GUIFEATURESLOADER instanceof RandomWalkGUIFeatures))
        {
            GUIFEATURESLOADER = new RandomWalkGUIFeatures(g);
        }
//            }
//            else
//            {
